...
const AddEdit = () => {
    ...
    // destructuring every props of the object so that we need not to write these use state.name, state.email etc..
  ...
  return (
    <div style={{marginTop: "100px"}}>
        ...
        >
          ...
          <input type='email' id='email' name='email' placeholder='Enter your email address...' value={email || ""} onChange={handleInputChange} />
